...
#include "../../WexChat-client/newuserwindow.h"
...
QT_MOC_LITERAL(1, 14, 12), // "changeSignal"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "NewUserWindow\0changeSignal\0"
};
...
void NewUserWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (NewUserWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NewUserWindow::changeSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NewUserWindow::changeSignal()
{
