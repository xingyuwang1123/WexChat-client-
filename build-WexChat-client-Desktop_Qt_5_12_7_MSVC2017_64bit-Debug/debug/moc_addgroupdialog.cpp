...
#include "../../WexChat-client/addgroupdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddGroupDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddGroupDialog_t qt_meta_stringdata_AddGroupDialog = {
    {
QT_MOC_LITERAL(0, 0, 14) // "AddGroupDialog"
...
QT_INIT_METAOBJECT const QMetaObject AddGroupDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_AddGroupDialog.data,
    qt_meta_data_AddGroupDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddGroupDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddGroupDialog.stringdata0))
