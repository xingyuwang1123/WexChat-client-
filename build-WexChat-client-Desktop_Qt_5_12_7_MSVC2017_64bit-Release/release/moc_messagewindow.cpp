...
#include "../../WexChat-client/messagewindow.h"
...
QT_MOC_LITERAL(1, 14, 10), // "itemLoadok"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "MessageWindow\0itemLoadok\0"
};
...
void MessageWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageWindow::itemLoadok)) {
                *result = 0;
                return;
            }
        }
